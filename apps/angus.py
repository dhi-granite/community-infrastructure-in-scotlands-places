...
ccch_decile = pd.read_csv("data/angus/ccch_decile_angus.csv")
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Angus"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="angus-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("angus-card-content", "children"), 
