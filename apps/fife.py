...
ccch_decile = pd.read_csv("data/fife/ccch_decile_fife.csv")
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Fife"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="fife-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("fife-card-content", "children"), 
