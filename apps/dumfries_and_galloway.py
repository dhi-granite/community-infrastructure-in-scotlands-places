...
ccch_decile = pd.read_csv("data/dumfries_and_galloway/ccch_decile_dumfries_and_galloway.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/dumfries_and_galloway_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Dumfries and Galloway"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="dumfries-and-galloway-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("dumfries-and-galloway-card-content", "children"), 
