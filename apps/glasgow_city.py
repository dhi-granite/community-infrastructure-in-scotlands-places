...
ccch_decile = pd.read_csv("data/glasgow_city/ccch_decile_glasgow_city.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/glasgow_city_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Glasgow City"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="glasgow-city-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("glasgow-city-card-content", "children"), 
