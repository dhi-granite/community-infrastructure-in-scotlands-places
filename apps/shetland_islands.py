...
ccch_decile = pd.read_csv("data/shetland_islands/ccch_decile_shetland_islands.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/shetland_islands_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in the Shetland Islands"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="shetland-islands-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("shetland-islands-card-content", "children"), 
