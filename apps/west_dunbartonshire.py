...
ccch_decile = pd.read_csv("data/west_dunbartonshire/ccch_decile_west_dunbartonshire.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/west_dunbartonshire_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in West Dunbartonshire"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="west-dunbartonshire-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("west-dunbartonshire-card-content", "children"), 
