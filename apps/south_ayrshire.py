...
iz_info = pd.read_csv("data/south_ayrshire/iz_info_south_ayrshire.csv")
iz_info_table = pd.read_csv("data/south_ayrshire/iz_info_dash_table_south_ayrshire.csv")
shs_mao = pd.read_csv("data/south_ayrshire/mao_shs_south_ayrshire.csv")
businesses_decile = pd.read_csv("data/south_ayrshire/businesses_decile_south_ayrshire.csv")
charities_decile = pd.read_csv("data/south_ayrshire/charity_decile_south_ayrshire.csv")
ccch_decile = pd.read_csv("data/south_ayrshire/ccch_decile_south_ayrshire.csv")
...
scatter_charities_businesses = px.scatter(
    ...
    labels={"Number of businesses": "Number of businesses", "Number of charities": "Number of charities"},
    width=700,
    height=400,
    title="Number of businesses versus number of charities by intermediate zone",
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/south_ayrshire_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in South Ayrshire"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="south-ayrshire-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("south-ayrshire-card-content", "children"), 
