...
ccch_decile = pd.read_csv("data/stirling/ccch_decile_stirling.csv")
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Stirling"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="stirling-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("stirling-card-content", "children"), 
