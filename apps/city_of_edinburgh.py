...
iz_info = pd.read_csv("data/city_of_edinburgh/iz_info_city_of_edinburgh.csv")
iz_info_table = pd.read_csv("data/city_of_edinburgh/iz_info_dash_table_city_of_edinburgh.csv")
shs_mao = pd.read_csv("data/city_of_edinburgh/mao_shs_city_of_edinburgh.csv")
businesses_decile = pd.read_csv("data/city_of_edinburgh/businesses_decile_city_of_edinburgh.csv")
charities_decile = pd.read_csv("data/city_of_edinburgh/charity_decile_city_of_edinburgh.csv")
ccch_decile = pd.read_csv("data/city_of_edinburgh/ccch_decile_city_of_edinburgh.csv")

iz_info = iz_info.sort_values("Community")
iz_info_wanted_cols = ["Community", "Mean SIMD Decile", "Female life expectancy", "Male life expectancy", "Businesses per 1000 people", "Local charities per 1000 people", "Commmunity spaces per 1000 people"]
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/city_of_edinburgh_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in the City of Edinburgh"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="city-of-edinburgh-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("city-of-edinburgh-card-content", "children"), 
