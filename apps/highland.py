...
ccch_decile = pd.read_csv("data/highland/ccch_decile_highland.csv")
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Highland"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="highland-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("highland-card-content", "children"), 
