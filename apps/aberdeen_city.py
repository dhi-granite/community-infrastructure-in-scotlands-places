...
iz_info_table = pd.read_csv("data/aberdeen_city/iz_info_dash_table_aberdeen_city.csv")
shs_mao = pd.read_csv("data/aberdeen_city/mao_shs_aberdeen_city.csv")
businesses_decile = pd.read_csv("data/aberdeen_city/businesses_decile_aberdeen_city.csv")
charities_decile = pd.read_csv("data/aberdeen_city/charity_decile_aberdeen_city.csv")
...
scatter_charities_cspaces = px.scatter(
    ...
    y="Local charities per 1000 people",
    labels={"Community spaces per 1000 people": "Community spaces per 1000 people", "Local charities per 1000 people": "Local charities per 1000 people"},
    width=700,
    height=400,
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/aberdeen_city_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Aberdeen City"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="aberdeen-city-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("aberdeen-city-card-content", "children"), 
