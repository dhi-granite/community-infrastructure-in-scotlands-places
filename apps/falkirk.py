...
ccch_decile = pd.read_csv("data/falkirk/ccch_decile_falkirk.csv")
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Falkirk"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="falkirk-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("falkirk-card-content", "children"), 
