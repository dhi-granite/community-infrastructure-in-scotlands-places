...
ccch_decile = pd.read_csv("data/north_ayrshire/ccch_decile_north_ayrshire.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/north_ayrshire_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in North Ayrshire"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="north-ayrshire-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("north-ayrshire-card-content", "children"), 
