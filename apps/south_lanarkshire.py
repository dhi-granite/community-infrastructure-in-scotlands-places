...
ccch_decile = pd.read_csv("data/south_lanarkshire/ccch_decile_south_lanarkshire.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/south_lanarkshire_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in South Lanarkshire"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="south-lanarkshire-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("south-lanarkshire-card-content", "children"), 
