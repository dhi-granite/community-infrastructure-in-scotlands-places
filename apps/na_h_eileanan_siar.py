...
ccch_decile = pd.read_csv("data/na_h-eileanan_siar/ccch_decile_na_h-eileanan_siar.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/na_h-eileanan_siar_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Na h-Eileanan Siar"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="na-h-eileanan-siar-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("na-h-eileanan-siar-card-content", "children"), 
