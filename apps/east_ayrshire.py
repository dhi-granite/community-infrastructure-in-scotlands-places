...
iz_info_table = pd.read_csv("data/east_ayrshire/iz_info_dash_table_east_ayrshire.csv")
shs_mao = pd.read_csv("data/east_ayrshire/mao_shs_east_ayrshire.csv")
businesses_decile = pd.read_csv("data/east_ayrshire/businesses_decile_east_ayrshire.csv")
charities_decile = pd.read_csv("data/east_ayrshire/charity_decile_east_ayrshire.csv")
ccch_decile = pd.read_csv("data/east_ayrshire/ccch_decile_east_ayrshire.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/east_ayrshire_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in East Ayrshire"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="east-ayrshire-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("east-ayrshire-card-content", "children"), 
