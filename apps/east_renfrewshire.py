...
ccch_decile = pd.read_csv("data/east_renfrewshire/ccch_decile_east_renfrewshire.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/east_renfrewshire_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in East Renfrewshire"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="east-renfrewshire-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("east-renfrewshire-card-content", "children"), 
