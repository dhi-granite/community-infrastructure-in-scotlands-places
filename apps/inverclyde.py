...
ccch_decile = pd.read_csv("data/inverclyde/ccch_decile_inverclyde.csv")

iz_info = iz_info.sort_values("Community")
iz_info_wanted_cols = ["Community", "Mean SIMD Decile", "Female life expectancy", "Male life expectancy", "Businesses per 1000 people", "Local charities per 1000 people", "Commnity spaces per 1000 people"]
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/inverclyde_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Inverclyde"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
                ...
                dbc.CardHeader(
                    dbc.Tabs(
                        [
                            ...
                            dbc.Tab(label="Charities/Communtiy spaces", tab_id="charities-cspaces-scatter"),
                        ],
                        id="card-tabs",
                        active_tab="map"
                    )
                ),
                dbc.CardBody(html.Div(id="inverclyde-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("inverclyde-card-content", "children"), 
