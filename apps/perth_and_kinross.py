...
ccch_decile = pd.read_csv("data/perth_and_kinross/ccch_decile_perth_and_kinross.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/perth_and_kinross_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Perth and Kinross"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="perth-and-kinross-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("perth-and-kinross-card-content", "children"), 
