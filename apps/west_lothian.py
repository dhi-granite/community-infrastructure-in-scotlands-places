...
ccch_decile = pd.read_csv("data/west_lothian/ccch_decile_west_lothian.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/west_lothian_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in West Lothian"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="west-lothian-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("west-lothian-card-content", "children"), 
