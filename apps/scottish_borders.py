...
ccch_decile = pd.read_csv("data/scottish_borders/ccch_decile_scottish_borders.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/scottish_borders_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in the Scottish Borders"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="scottish-borders-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("scottish-borders-card-content", "children"), 
