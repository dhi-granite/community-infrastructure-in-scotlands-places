...
ccch_decile = pd.read_csv("data/argyll_and_bute/ccch_decile_argyll_and_bute.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/argyll_and_bute_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Argyll and Bute"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="argyll-and-bute-card-content", className="card-text"))
            ]
        ),
    ]
)  
