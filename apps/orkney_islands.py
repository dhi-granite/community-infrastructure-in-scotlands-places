...
ccch_decile = pd.read_csv("data/orkney_islands/ccch_decile_orkney_islands.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/orkney_islands_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in the Orkney Islands"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="orkney-islands-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("orkney-islands-card-content", "children"), 
