...
iz_info = pd.read_csv("data/north_lanarkshire/iz_info_north_lanarkshire.csv")
iz_info_table = pd.read_csv("data/north_lanarkshire/iz_info_dash_table_north_lanarkshire.csv")
shs_mao = pd.read_csv("data/north_lanarkshire/mao_shs_north_lanarkshire.csv")
businesses_decile = pd.read_csv("data/north_lanarkshire/businesses_decile_north_lanarkshire.csv")
charities_decile = pd.read_csv("data/north_lanarkshire/charity_decile_north_lanarkshire.csv")
ccch_decile = pd.read_csv("data/north_lanarkshire/ccch_decile_north_lanarkshire.csv")
...
map_la = html.Div(
                children=[
                    html.Iframe(
                        src="../assets/north_lanarkshire_map.html", 
...
layout = dbc.Container(
    [
        html.H3("Community Assets in North Lanarkshire"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="north-lanarkshire-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("north-lanarkshire-card-content", "children"), 
