...
ccch_decile = pd.read_csv("data/moray/ccch_decile_moray.csv")
...
layout = dbc.Container(
    [
        html.H3("Community Assets in Moray"),
        html.Hr(),
        html.Div(
            children=[
                html.Div(
        ...
        dbc.Card(
            [
                ...
                dbc.CardBody(html.Div(id="moray-card-content", className="card-text"))
            ]
        ),
    ]
)  
...
@app.callback(
        Output("moray-card-content", "children"), 
